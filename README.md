...
2. Click on this link: [https://github.com/murakamifan/Bot/raw/master/placenlbot.user.js](https://github.com/murakamifan/Bot/raw/master/placenlbot.user.js). If everything went well you'll see Tampermonkey ask you to add it. Click **Install**.
